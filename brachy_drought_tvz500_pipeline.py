...
img, path, filename = pcv.readimage(filename='/shares/mgehan_share/mgehan/brachypodium-2020-ella/brachy-drought/B002dr_022315/snapshot276515/VIS_TV_z500_h1_g0_e110_380017_0.png')
...
newmask = pcv.crop_position_mask(img=nir, mask=nmask, x=10, y=10, 
                                 v_pos="bottom", h_pos="right")
