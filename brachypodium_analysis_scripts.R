...
setwd("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-heatdrought/")

#####################################################################
# only do this part the first time you read in the control/drought multi-value data #
#####################################################################
...
barcodes <- read.csv("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-drought/brachy-drought-barcodes.csv")
...
#####################################################################
# only do this part the first time you read in the control/drought single-value data #
#####################################################################
...
colnames(DFs)[3] <- "Genotype"
length(unique(DFs$Genotype))

#read in locations csv file and keep relevant info
locations <- read.csv("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-drought/brachy-locations.csv")
...
#####################################################################
# only do this part the first time you read in the heat/heat-drought multi-value data #
#####################################################################
...
#read in barcode csv file and keep relevant info
heatbarcodes <- read.csv("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-heatdrought/brachy-heatdrought-barcodes.csv")
...
#read in locations csv file and keep relevant info
locations <- read.csv("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-heatdrought/brachy-locations.csv")
locations = select(locations, Genotype, Collection_location, Latitude, Longitude, Elevation)
...
#####################################################################
# only do this part the first time you read in the heat/heat-drought single-value data #
#####################################################################
#read in single value trait csv files
...
#keep only genotypes that are in both experiments
heatDFs$compare.geno <- heatDFs$Genotype %in% list1
...
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_control.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_control.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,12,length=100), # for blue
               seq(13,25,length=100),  # for yellow
               seq(26,100,length=100)) # for orange
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_drought.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_drought.png",width = 900,height = 1000)
...
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_control.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_control.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,2,length=100), # for orange
               seq(3,4,length=100),  # for yellow
               seq(5,40,length=100)) # for blue
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_drought.pdf",width = 8,height = 8)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_drought.png",width = 900,height = 1000)
...
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_control.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_control.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,4,length=20), # for orange
               seq(5,7,length=20),  # for yellow
               seq(8,20,length=20)) # for blue
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_drought.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_drought.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,12,length=100), # for blue
               seq(13,25,length=100),  # for yellow
               seq(26,100,length=100)) # for orange
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_heat.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_heat.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,12,length=100), # for blue
               seq(13,25,length=100),  # for yellow
               seq(26,100,length=100)) # for orange
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_heat&drought.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/unhealthy_heatmap_heat&drought.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,2,length=100), # for orange
               seq(3,4,length=100),  # for yellow
               seq(5,40,length=100)) # for blue
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_heat.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_heat.png",width = 900,height = 1000)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/heatmap_genotypes.png",width = 900,height = 1200)
...
col_breaks = c(seq(0,2,length=100), # for orange
               seq(3,4,length=100),  # for yellow
               seq(5,40,length=100)) # for blue
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_heat&drought.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/area_heatmap_heat&drought.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,4,length=20), # for orange
               seq(5,7,length=20),  # for yellow
               seq(8,20,length=20)) # for blue
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_heat.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_heat.png",width = 900,height = 1000)
...
col_breaks = c(seq(0,4,length=20), # for orange
               seq(5,7,length=20),  # for yellow
               seq(8,20,length=20)) # for blue
pdf(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_heat&drought.pdf",width = 10,height = 10)
png(file="/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/height_heatmap_heat&drought.png",width = 900,height = 1000)
...
bio_cor <- cor(bio)
pdf(file= "/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/climatecorrelationplot.pdf", width = 6, height = 7)
png(file= "/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/climatecorrelationplot.png", width = 1200, height = 1400)
...
climate_pca <- ggplot(pca_df, aes(x = PC1, y = PC2, color = Country))+
  ...
  geom_point()
climate_pca
ggsave(plot = climate_pca,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/climatepca.png", width = 7.25, height = 6, dpi = 300)
ggsave(plot = climate_pca,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/climatepca.pdf", width = 7.25, height = 6, dpi = 300)
...
map
ggsave(plot = map,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/collectionlocationmap.png", width = 6, height = 4, dpi = 300)
ggsave(plot = map,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/collectionlocationmap.pdf", width = 6, height = 4, dpi = 300)




###############################################################
### GBS Data and GWAS/Heritability ### ##control WW and WL
###############################################################
# Read in GBS data
...
joined_pca_df <- join(gbs_pca[,2:5], pca_df, by="Genotype")
...
p2
ggsave("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/variance_explained_controlWW&WL.png",width=5.5,height=5.54,plot = p2, dpi = 300)
ggsave("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/variance_explained_controlWW&WL.pdf",width=7.17,height=5.54,plot = p2, dpi = 300)
...
plot(-log10(p.adjust(unlist(my_gwas2),method="fdr")),pch=16,col="grey20",main="WW and WL in Control",xlab="SNP",ylab="-log10(P)")
...
gwas_joined <- join(chrominfo, my_gwas2_copy.df, by="ID", type="left")
...
manhattan <- ggplot(don, aes(x=POScum, y=-log10(Value))) +
  # Show all points
...
manhattan
ggsave(plot = manhattan,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/manhattanplot.png", width = 6, height = 4, dpi = 300)
ggsave(plot = manhattan,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/manhattanplot.pdf", width = 6, height = 4, dpi = 300)


###############################################################
### GBS Data and GWAS/Heritability ### ## control WW and heat WW
###############################################################
...
p3 <- ggplot(data=H4_melt,aes(Shape,value*100))+
  ...
  theme(axis.text.x = element_text(angle = 50, hjust = 1))
p3
ggsave("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/variance_explained_control&HeatWW.png",width=5.5,height=5.54,plot = p3, dpi = 300)
ggsave("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/variance_explained_control&HeatWW.pdf",width=7.17,height=5.54,plot = p3, dpi = 300)
...
plot(-log10(p.adjust(unlist(my_gwas3),method="fdr")),pch=16,col="grey20",main="WW in Control and Heat",xlab="SNP",ylab="-log10(P)")
abline(h=-log10(0.00001), col="orange")
...
manhattan3 <- ggplot(don3, aes(x=POScum, y=-log10(Value))) +
  # Show all points
  geom_point(aes(color=as.factor(CHROM)), alpha=0.8, size=1.3) +
  scale_color_manual(values = rep(c("black", "grey"), 5 )) +
  # custom axis:
...
manhattan3
ggsave(plot = manhattan3,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/manhattanplot.png", width = 6, height = 4, dpi = 300)
ggsave(plot = manhattan3,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/manhattanplot.pdf", width = 6, height = 4, dpi = 300)

###############################################################
### GBS Data and GWAS/Heritability ### ## control WW and heat WL
###############################################################
...
p4 <- ggplot(data=H5_melt,aes(Shape,value*100))+
  ...
  theme(axis.text.x = element_text(angle = 50, hjust = 1))
p4
ggsave("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/variance_explained_controlWW&HeatWL.png",width=5.5,height=5.54,plot = p4, dpi = 300)
ggsave("/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/variance_explained_controlWW&HeatWL.pdf",width=7.17,height=5.54,plot = p4, dpi = 300)
...
snp_names <- colnames(joined_pca_df_final)[16:ncol(joined_pca_df_final)]
...
# Make the Manhattan plot on the gwas4_joined dataset
...
manhattan4 <- ggplot(don4, aes(x=POScum, y=-log10(Value))) +
  # Show all points
  geom_point(aes(color=as.factor(CHROM)), alpha=0.8, size=1.3) +
  scale_color_manual(values = rep(c("black", "grey"), 5 )) +
  # custom axis:
...
################################################################
# Combine all GWAS results together to make one manhattan plot
################################################################
...
don_all <- allgwas_melt %>% 
  ...
  # Add this info to the initial dataset
  left_join(all, ., by=c("CHROM"="CHROM")) %>%
...
ggsave(plot = manhattan_all,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/manhattanplot.png", width = 6, height = 4, dpi = 300)
ggsave(plot = manhattan_all,"/Users/ellaludwig/Desktop/Danforth-Center/brachy-data/brachy-figures/manhattanplot.pdf", width = 6, height = 4, dpi = 300)

#see how many significant snps from each comparison
don_all
don_all2 <- filter(don_all, (p.adj < 5e-10))
filter(don_all2, (variable == "Control.Drought"))
filter(don_all2, (variable == "Control.Heat"))
filter(don_all2, (variable == "Control.HeatDrought"))
